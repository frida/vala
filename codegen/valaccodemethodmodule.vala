			...
			if (m.body != null) {
				...
				if (m.closure) {
					...
					if (m.binding == MemberBinding.INSTANCE) {
						...
						ccode.add_declaration (get_ccode_name (SemanticAnalyzer.get_data_type_for_symbol (current_type_symbol)), new CCodeVariableDeclarator ("self"), CCodeModifiers.UNUSED);
